...
Character newCharacter(char symbol, int size, int width) {
...
struct Map {
  ...
  struct Character T = newCharacter('T', 2, 5);
  struct Character U = newCharacter('U', 3, 4);
  struct Character V = newCharacter('V', 3, 5);
  ...
  struct Character unknown = newCharacter('\0', 11, 3);
